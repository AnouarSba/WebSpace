...
<body>
	<div class="container">
		<h1 class="page-header text-center">فضاء خاص للاصغاء لمقترحات  الزبائن</h1>
		<div class="row">
			...
			<!--	<input type="date" name="" id="min">
				<input type="date" name="" id="max"> -->
				
				<div class="row" dir="rtl">
					<label>عرض الاقتراحات حسب: </label>

				<select class="sel">
					<option value="1">الكل</option>
					<option value="">الاقتراحات غير المدروسة</option>
					<option value="تمت  دراسته">الاقتراحات المدروسة</option>
					<option value="محفوظ">الاقتراحات المحفوظة</option>
				</select>
						...
						<tbody>
							...
							while ($row = $query->fetch_assoc()) {
								...
								if ($row['status'] !=1 ) {
									...
									$b2= "	<a data-toggle='modal' onclick='sv2(". $row['id'] .");' data-target='#exampleModal' class='btn btn-danger btn-sm' data-toggle='modal'> دراسة</a>";
								} else {
									$b2 = " <a data-toggle='modal' onclick='sv2(". $row['id'] .");' data-target='#exampleModal' class='btn btn-danger btn-sm' data-toggle='modal'>تعديل الاجراء</a>";
								}
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel" style="color: black;font-size: 22px">دراسة اقتراح</h5>
				...
				<div class="modal-body" style="color:black">
					<form action="msg_1.php" method="get">
	...
	<div class="modal fade" style="direction:rtl" id="exampleModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel" style="color: black;font-size: 22px">حفظ  اقتراح</h5>
					<button type="button" style="position:absolute;float:left;left:0" class="close" data-dismiss="modal" aria-label="Close">
						<span aria-hidden="true">&times;</span>
					</button>
				</div>
				<div class="modal-body" style="color:black">
					هل أنت متأكد من حفظ هذا الاقتراح؟
				</div>
				<div class="modal-footer">
					<form action="msg_1.php" method="get">
