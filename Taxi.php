            ...
            <div class="container" dir="rtl" style="text-align: right;">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3">
                        <div class="card">
                            <a class="img-card" href="reglement_taxi.php">
                            ...
                            <div class="card-content"  style="text-align: right;" dir="rtl">
                                <h4 class="card-title" dir="rtl">
                                    <a href="reglement_taxi.php" style="text-align: right;" dir="rtl"> قوانين و تنظيمات
                                  </a>
                                </h4>
                                <p class="">
                                    قانون سيارات الأجرة
                            ...
                            <div class="card-read-more">
                                <a href="reglement_taxi.php" class="btn btn-link btn-block">
                                    اقرأ المزيد
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-xs-12 col-sm-3">
                        <div class="card">
            <a  class="img-card" href="inscription_taxi.php">
                            ...
                            <div class="card-content"  style="text-align: right;">
                                <h4 class="card-title">
            <a href="inscription_taxi.php">
                                     التسجيل الالكتروني
                                  </a>
                                </h4>
                                <p class="">
                                      التسجيل للحصول على دفتر المقاعد
                                </p>
                            </div>
                            <div class="card-read-more">
            <a  class="btn btn-link btn-block" href="inscription_taxi.php">
                    ...
                    <div class="col-xs-12 col-sm-3">
                     ...
                     <div class="col-xs-12 col-sm-3">
                        <div class="card">
            <a  class="img-card"  href="#" onclick="swalert2();">
                            
                            <img src="assets/image/ereg.jpg"  style="object-fit: scale-down; background-color: teal" />
                          </a>
                            <div class="card-content"  style="text-align: right;">
                                <h4 class="card-title">
            <a href="#" onclick="swalert2();">
                                   فضاء مديرية النقل
                                  </a>
                                </h4>
                                <p class="">
                            ...
                            <div class="card-read-more">
            <a  class="btn btn-link btn-block"  href="#" onclick="swalert2();">
...
<script >
  ...
  html: "<form id='form' action='Formations_content_Capp.php' method='POST' onsubmit='valid()'><input type='text' id='pswd' name='pswd' placeholder='رمز المستخدم'><br><div id='err' hidden>يرجى ادخال رمز المستخدم</div><div id='wrong' hidden>رمز المستخدم خاطئ</div><br> <input type='submit' value='تأكيد'></form>",
  ...
  animation: "slide-from-top",
    ...
    function swalert2() {
    swal.fire({
  title: "فضاء خاص بمديرية النقل",
  text: "أدخل بيانات المستخدم ",
  html: "<form id='form2' action='Taxi_candidat.php' method='POST' onsubmit='valid2()'> <select name='wilaya' style='width: 90%; margin:15px' required > <option value=''>-- اختيار مديرية النقل --</option>       <option value='0'>مديرية النقل لولاية سيدي بلعباس</option>      <option value='1'>مديرية النقل لولاية  تلمسان</option>      <option value='2'>مديرية النقل لولاية عين تموشنت</option>      <option value='3'>مديرية النقل لولاية  مستغانم</option>      <option value='4'>مديرية النقل لولاية  وهران</option>      <option value='5'>مديرية النقل لولاية  بلعبغليزاناس</option>      <option value='6'>مديرية النقل لولاية  النعامة</option>    </select><br><input type='text' id='pswrd' style='width: 90%' name='pswrd' placeholder=' الرقم السري '><br><br><div id='err' hidden>يرجى ادخال  البيانات</div><div id='wrong' hidden> الرقم السري خاطئ</div><br><br> <input type='submit' value='دخول'></form>",
 ...
 function valid2() {
  ...
  if (document.getElementById("pswrd").value != "$DtWsCf538" ) {
    document.getElementById("err").hidden = true;
    document.getElementById("wrong").hidden = false;
  }
  else{
