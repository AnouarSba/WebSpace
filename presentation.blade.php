...
<div class="tabs">
  ...
  <div class="content" style="font-family: Aparajita;font-size: 25px">
    <section>
...
بالشخصية المعنوية والإستقلال المالي ،تخضع للقواعد الإدارية في علاقاتهـــــــــــا مع الدولــــــة وذلك تحت وصاية وزارة النقـــــل.
          ...
          <div class="col-6">
          <img src="{{ asset('assets/image/intro-carousel/station.jpg') }}" alt="" width="80%" height="100%">
...
<img src="{{ asset('assets/image/cadre.jpg') }}" alt="" width="35%" height="350px">
</center>
