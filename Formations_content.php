        ...
        <div class="content">
            <div class="container" dir="rtl" style="text-align: right;">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-4">
                        <div class="card">
            <a  class="img-card"  href="info_formations.php">
            ...
            <a href="info_formations.php">
                            ...
                            <div class="card-read-more">
            <a  class="btn btn-link btn-block"  href="info_formations.php">
    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content" style="top: 150px">
        ...
        <div class="modal-body" style="width: 80%; color:black;width: 95%; margin: auto;">
            ...
            <div class=" col-6  justify-content-center" style="text-align: right; font-size: 22px" data-aos="zoom-out" >
            	<h3>مقاييس تخصص نقل الأشخاص</h3><br>
            <a  class="diagonalfill" target="_blank" href="CentreFormation/Trp/Cours1.php">أبعاد النقل و الجانب التنظيمي المتعلق بنقل الأشخاص</a> &nbsp; <a href="CentreFormation/Trp/Cours1.php" download>تحميل</a><br><br>
            <a  class="diagonalfill" target="_blank" href="CentreFormation/Trp/Cours2.php">المفاهيم التقنية لمركبات نقل الأشخاص</a> &nbsp; <a href="CentreFormation/Trp/Cours2.php" download>تحميل</a><br><br>
            <a  class="diagonalfill" target="_blank" href="CentreFormation/Trp/Cours3.php">الوقاية و السلامة لنقل الأشخاص</a> &nbsp; <a href="CentreFormation/Trp/Cours3.php" download>تحميل</a><br><br>
            <a  class="diagonalfill" target="_blank" href="CentreFormation/Trp/Cours5.php">فن حسن التصرف</a> &nbsp; <a href="CentreFormation/Trp/Cours5.php" download>تحميل</a>
            </div>
            <div class=" col-6  justify-content-center" data-aos="zoom-out" style="text-align: right; font-size: 22px" data-aos-delay="200">
            	<h3>مقاييس تخصص نقل البضائع</h3><br>

            <a  class="diagonalfill" target="_blank" href="CentreFormation/Trobj/Cours1.php">أبعاد النقل و الجانب التنظيمي المتعلق بنقل البضائع</a> &nbsp; <a href="CentreFormation/Trobj/Cours1.php" download>تحميل</a><br><br>
            <a  class="diagonalfill" target="_blank" href="CentreFormation/Trobj/Cours2.php">المفاهيم التقنية لمركبات ذات محرك الخاص بنقل البضائع</a> &nbsp; <a href="CentreFormation/Trobj/Cours2.php" download>تحميل</a><br><br>
            <a  class="diagonalfill" target="_blank" href="CentreFormation/Trobj/Cours3.php">الوقاية و السلامة أثناء نقل البضائع</a> &nbsp; <a href="CentreFormation/Trobj/Cours3.php" download>تحميل</a><br><br>
