...
<nav class="nav">
  ...
  <ul id="menuList" class="menu inactive" style="   
   ...
   <!-- <li id="f" class="item"><a href="Formations.php"> الدورات التكوينية  &nbsp; &nbsp; <i class="fa-light fa-graduation-cap"></i></a></li>
    ...
    <li id="l" class="item"><a href="list_taxi.php">قوائم المقبولين &nbsp; &nbsp; <i class="fa-light fa-list"></i></a></li>
    <li id="c" class="item"><a href="Taxi_candidat.php">الرئيسية &nbsp; &nbsp; <i class="fa-light fa-home"></i></a></li>
</ul>
</nav>
