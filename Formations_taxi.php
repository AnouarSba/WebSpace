...
<body>
<div class="container">
	<h1 class="page-header text-center">الدورات التكوينية الخاصة بدفتر المقاعد</h1>
	<div class="row">
		<div class="col-sm-8 col-sm-offset-2">
			...
			<div class="row" dir="rtl">
				<div class="col-2">
					<a href="add_formation_taxi.php" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> اضافة  </a> 
				</div>
				...
				<table id="myTable" class="table table-bordered table-striped" dir="rtl">
					...
					<tbody>
						<?php
							...
							$sql = "SELECT * FROM formation_taxi ";
							...
							while($row = $query->fetch_assoc()){
								...
								if ($row['grp']>1) {
									for ($i=1; $i <= $row['grp'] ; $i++) { 
										$result = $conn -> query("SELECT count(id) FROM condidat_f_taxi where redoublant=0 and  id_f=".$row['id']." and grp=".$i);
    ...
    if ($row_c) {
   	$com = '';
    	...
    	$open = "<form action='reunion_taxi.php' method='get'>
                      ...
                      </form> <form action='Evaluation_taxi.php' method='get'>
   	...
   	$open = '';
                      $com= '';}
    							...
    							$act = "<td style='width:300px;'>".$arr.$com.$open." 
									</td>";
    						...
    						*/if ($row['duree'] == 1) {
								...
								"<tr>
									...
									<td style='width:250px;'>".$row['date_f']."</td>
									<td style='width:250px;'>".$row['nbr_c'].'<br>'.$grp."</td>
									<td style='width:250px;'>".$row["created_at"]."</td>
									".$act."
								</tr>";
