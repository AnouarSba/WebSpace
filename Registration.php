...
if (isset($_POST['firstname'])) {
  ...
  footer: 'لتأكيد طلبك يرجى الاتصال بمركز التكوين عبر: <br> 048764072 <br>cf22sba@gmail.com'
    ...
    $sql = "UPDATE client SET firstname = '$request_firstname', lastname = '$request_lastname', birthplace ='$request_birthplace' ,birthdate ='$request_birthdate' , training = '$request_training' , address = '$request_address', phone = '$request_phone', mail = '$request_mail',drivinglicensedate ='$request_drivinglicensedate' , drivinglicense = '$request_drivinglicense', commune = '$request_commune', drivinglicenseclass = '$request_drivinglicenseclass', created_at = '$now', user = '$x' where id= $cl";
    ...
    $result = $mysqli -> query("SELECT entreprise FROM client where id = $cl");
    $row = $result->fetch_row();
    $id_d = $row[0];
    $ep='';
    if($id_d){
...
if ($mysqli -> connect_errno) {
 ...
 $sql = "SELECT id,firstname,lastname FROM client ";
