...
<div class="row col-12 justify-content-center" style="font-family: Aparajita;font-size: 25px;direction:rtl;">
    ...
    <center><h1 class="" style="color: #3d80e4">المحطات الحضرية
 </h1></center>
        <div class="" style="text-align: center;font-family: Aparajita;font-size: 25px">
    <p > تستغل المؤسسة العمومية للنقل الحضري وشبه الحضري لولاية سيدي بلعباس محطتين حضريتين هما:</p>
    </div>
    ...
    <div class="card-header" id="headingOne" style="direction:rtl;text-align: right;font-size: 28px;">
      <h5 class="mb-0 mr-0">
        <button class="btn btn-link collapsed" data-toggle="collapse" style="direction:rtl;text-align: right;font-size: 28px;" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
          محطة الشهيد خياطي معمر المتواجدة بحي الأمير عبد القادر
        </button>
      </h5>
    </div>
    ...
    <div id="collapseOne" class="collapse " aria-labelledby="headingOne"  style="direction:rtl;" data-parent="#accordion">
      ...
      محطة عصرية مخصصة لانطلاق الحافلات بالمسارات شبه الحضرية مجهزة بمكاتب ادارية مكيفة ، وقاعة الجلوس للمسافرين و مصلى
بالاضافة الى المرافق الصحية و الكافيتيريا و شاشات العرض اما بالنسبة للمحيط الخارجي
.فتحتوي على مكان توقف الحافلات و مكان وقوف المسافرين مجهزة بالواقيات

      </div>
      <div class="col-6">
      <video width="100%" height="400" controls="" >
  <source src="{{ asset('assets/video/station.mp4') }}" type="video/mp4">
  <source src="movie.ogg" type="video/ogg">
    ...
    <div class="card-header"  style="direction:rtl;text-align: right;" id="headingTwo">
      <h5 class="mb-0">
        ...
        المحطة الحضرية رقم 17 المتواجدة بوسط ولاية سيدي بلعباس
       </button>
      </h5>
    </div>
    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
      ...
      محطة حضرية متواجدة بوسط مدينة سيدي بلعباس مخصصة لانطلاق الحافلات عبر المسارات الحضرية.

      </div>
      <div class="row justify-content-center">
      <div class="col-10">
      <img src="{{ asset('assets/image/a_bus_17.jpg') }}" alt="" width="100%" height="80%">

      </div>
      <!-- <div class="col-6">
      <img src="{{ asset('assets/image/m_17_2.jpg') }}" alt="" width="80%" height="80%">

      </div>  -->
       <!-- <div class="col-6">
      <img src="{{ asset('assets/image/gch.jpg') }}" alt="" width="50%" height="100%">
