...
<i class="bi bi-caret-left-fill"></i>
 حي بن حمودة</h4>
      <img src="{{ asset('assets/image/t16i.jpg') }}" alt="" width="100%" height="100%">
...
<i class="bi bi-caret-left-fill"></i>
 سيدي لحسن</h4>
      <img src="{{ asset('assets/image/t11i.jpg') }}" alt="" width="100%" height="100%">
...
<i class="bi bi-caret-left-fill"></i>
 تلموني الجديدة</h4>
      <img src="{{ asset('assets/image/t25i.jpg') }}" alt="" width="100%" height="100%">
...
<i class="bi bi-caret-left-fill"></i>
 قايد بلعربي</h4>
      <img src="{{ asset('assets/image/t26i.jpg') }}" alt="" width="100%" height="100%">
...
<i class="bi bi-caret-left-fill"></i>
 البواعيش</h4>
      <img src="{{ asset('assets/image/t27i.jpg') }}" alt="" width="100%" height="100%">
...
<i class="bi bi-caret-left-fill"></i>
 سيدي حمادوش
      ...
      <img src="{{ asset('assets/image/t28i.jpg') }}" alt="" width="100%" height="100%">
