...
<div class="row col-12 justify-content-center" style="top:80px; font-family: Aparajita;font-size: 25px;direction:rtl;">
 ...
 <div class="quiz-container" id="quiz">
      <form action="msg3.php" method="post" style="display: none;"> 
          <input type="text" id='rep1'  name="rep1">
      ...
      <div class="ratings-container div">
        ...
        <div onclick="document.getElementById('rep1').value='1' " class="rating">
          <img  src="https://i.ibb.co/fYN2rVn/no.png" alt="">
          <small>سيئة</small>
        </div>

        <div onclick="document.getElementById('rep1').value='2' " class="rating">
          <img src="https://i.ibb.co/3M8Ddsf/neutral.png" alt=""/>
          <small>متوسطة</small>
        </div>

        <div onclick="document.getElementById('rep1').value='3' " class="rating active">
      ...
      <div class="ratings-container div1 d-none">
        ...
        <div onclick="document.getElementById('rep2').value='1' "  class="rating">
          <img src="https://i.ibb.co/fYN2rVn/no.png" alt="">
          <small>سيئ</small>
        </div>

        <div onclick="document.getElementById('rep2').value='2' " class="rating">
          <img src="https://i.ibb.co/3M8Ddsf/neutral.png" alt=""/>
          <small>حسن</small>
        </div>

        <div onclick="document.getElementById('rep2').value='3' "   class="rating active">
          <img src="https://i.ibb.co/VVDYGLZ/yes.png" alt=""/>
          <small>جيد</small>
        </div>
      </div>
      <div class="ratings-container div2 d-none">
        <div onclick="document.getElementById('rep3').value='1' "  class="rating">
          <img src="https://i.ibb.co/fYN2rVn/no.png" alt="">
          <small>سيئ</small>
        </div>

        <div onclick="document.getElementById('rep3').value='2' "  class="rating">
          <img src="https://i.ibb.co/3M8Ddsf/neutral.png" alt=""/>
          <small>حسن</small>
        </div>

        <div onclick="document.getElementById('rep3').value='3' "  class="rating active">
          <img src="https://i.ibb.co/VVDYGLZ/yes.png" alt=""/>
          <small>جيد</small>
        </div>
      </div>
